...
<body class="bg-black">
   <section>
        <div class="container mx-auto px-10 py-12">
            <div class="py-10">
                <h2 class="text-3xl font-black text-gray-100">Hello, &nbsp;<span class="text-[#3E25F6] hover:underline"><?php echo ucfirst($user);?></span> !</h2>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div class="col-span-1 bg-[#84DB8C] py-20 text-center rounded-2xl hover:scale-105 transition-all duration-300">
                    <a href="view_message.php?user=<?php echo $user?>" class="text-black font-bold text-5xl">View Message</a>
                </div>
            </div>
        </div>
   </section>
